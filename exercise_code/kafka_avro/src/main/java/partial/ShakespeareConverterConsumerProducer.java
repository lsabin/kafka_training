            ...
            try (KafkaConsumer<String,String> consumer = new KafkaConsumer<>(props)) {
	            ...
	            while(true) {
	                ...
	                for (ConsumerRecord<String, String> record : records) {
	                    ...
	                    ShakespeareValue value = getShakespeareLine(record.value());
	
	                    // TODO: Create the ProducerRecord with the Avro objects and send them
	                    ProducerRecord<Object, Object> avroRecord = new ProducerRecord<Object, Object>("shakespeare_avro_topic", shakespeareKey, value);
